...
void modoconf() {
  ...
  delay(100);
  digitalWrite(2, HIGH);//pin D0 ó 16  para el led indicador del AP
  delay(100);
  digitalWrite(2, LOW);
  delay(100);
  digitalWrite(2, HIGH);
...
void setup() {
  ...
  pinMode(12, INPUT);  //D1 o 5  para el pulsador de configuracion del AP
  if (digitalRead(12) == 0) {
    modoconf();
  }
...
//    Serial.println(subnet);
  ...
  if (digitalRead(16) == 0) { //-->gpio 12 o D6
